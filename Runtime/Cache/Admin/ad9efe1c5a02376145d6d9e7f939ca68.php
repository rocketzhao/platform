...
<?php switch($field["type"]): case "text": ?><input type="text" name="<?php echo ($field["name"]); ?>" value="<?php echo (htmlspecialchars($field["value"])); ?>"
    ...
    <?php case "colorPicker": $colorPicker = 1; ?>
        <div class="color-picker" style="width:100px;height: 30px;">
            <input type="text" name="<?php echo ($field["name"]); ?>" class="simple_color_callback form-control" onchange="setColorPicker(this);" value="<?php echo ((isset($field["value"]) && ($field["value"] !== ""))?($field["value"]):'#f36119'); ?>" style="width: 100px;"/>
        </div><?php break;?>
    ...
    <?php case "icon": ?><div class='icon-chose' title="选择icon" style="width: 400px;">
        ...
        <script src="/platform/Application/Admin/Static/zui/lib/chosen/chosen.icons.min.js"></script>
        <link href="/platform/Application/Admin/Static/zui/lib/chosen/chosen.icons.css" rel="stylesheet">
        <?php } ?>
        <script>
            $(function(){
...
<script type="text/javascript">
    ...
    <?php if($importDatetimePicker): ?><link href="/platform/Application/Admin/Static/zui/lib/datetimepicker/datetimepicker.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/platform/Application/Admin/Static/zui/lib/datetimepicker/datetimepicker.min.js"></script>
    ...
    <?php if($colorPicker): ?><script type="text/javascript" src="/platform/Application/Admin/Static/js/jquery.simple-color.js"></script>
        <script>
            $(function(){
    ...
    <script type="text/javascript" charset="utf-8" src="/platform/Public/js/ext/webuploader/js/webuploader.js"></script>
