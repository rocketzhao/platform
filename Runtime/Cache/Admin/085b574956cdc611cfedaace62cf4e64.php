...
<script type="text/javascript">
    ...
    <script type="text/javascript" src="/platform/Application/Admin/Static/zui/lib/highchart/highcharts.js"></script>
    ...
    <script>
        $('[data-role=saveCountSetting]').click(function () {
            $.post("/platform/index.php?s=/admin/index/index.html", {count_day: $('[name=count_day]').val()}, function (msg) {
                handleAjax(msg);
            });
        })
    </script>
