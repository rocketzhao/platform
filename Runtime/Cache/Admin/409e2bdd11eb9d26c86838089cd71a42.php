...
<form id="searchForm" method="get" action="<?php echo ((isset($searchPostUrl) && ($searchPostUrl !== ""))?($searchPostUrl):'/platform/index.php?s=/admin/weibo/weibo.html'); ?>" class="form-dont-clear-url-param">
...
<?php if(count($searches) > 0): ?><button class="btn submit-btn" url="?status=-1" target-form="ids" style="padding: 6px 16px;" onclick="toggle_search()">搜索</button><?php endif; ?>
            ...
            <div style="float: right;" >
                ...
                <form id="selectForm" method="get" action="<?php echo ((isset($selectPostUrl) && ($selectPostUrl !== ""))?($selectPostUrl):'/platform/index.php?s=/admin/weibo/weibo.html'); ?>" class="form-dont-clear-url-param">
