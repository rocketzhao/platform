...
<html lang="en" style="background: #4f8ad0">
    <head>
        <meta charset="UTF-8">
        <title>登录后台</title>
        <link rel="stylesheet" type="text/css" href="/platform/Application/Admin/Static/css/login.css" media="all">
        <!--zui-->
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><img class="logo" src="/platform/Application/Admin/Static/images/login_logo.png"> 登陆后台</h3>
