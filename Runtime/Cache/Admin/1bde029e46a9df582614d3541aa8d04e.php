...
<div class="panel-main" style="float:left;">
	...
	<script type="text/javascript" src="/platform/Public/static/uploadify/jquery.uploadify.min.js"></script>
    ...
    <?php case "picture_union": ?><div class="controls">
        ...
        <script type="text/javascript">
            ...
            $("#upload_picture_<?php echo ($o_key); ?>").uploadify({
                "height"          : 30,
                "swf"             : "/platform/Public/static/uploadify/uploadify.swf",
            ...
            function uploadPicture<?php echo ($o_key); ?>(file, data){
                ...
                var src = '';
                if(data.status){
                    src = data.url || '/platform' + data.path
                    $("#cover_id_<?php echo ($o_key); ?>").parent().find('.upload-img-box').append(
                            '<div class="upload-pre-item" val="' + data.id + '"><img src="/platform' + src + '" ondblclick="removePicture<?php echo ($o_key); ?>(this)"/></div>'
                    );
                                    ...
                                    function uploadPicture<?php echo ($o_tab_key); ?>(file, data){
                                        ...
                                        if(data.status){
                                            ...
                                            $("#cover_id_<?php echo ($o_tab_key); ?>").parent().find('.upload-img-box').append(
                                                    '<div class="upload-pre-item" val="' + data.id + '"><img src="/platform' + src + '" ondblclick="removePicture<?php echo ($o_tab_key); ?>(this)"/></div>'
                                            );
