    ...
    <nav class="navbar navbar-inverse admin-bar" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-collapse-example">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a target="_blank" href="<?php echo U('Home/Index/index');?>"disabled="disabled"><i class="icon-copy"></i> 配置页面</a></li>
                <li class="dropdown">
...
<form id="searchForm" method="get" action="<?php echo ((isset($searchPostUrl) && ($searchPostUrl !== ""))?($searchPostUrl):'/platform/index.php?s=/admin/senglin/index.html'); ?>" class="form-dont-clear-url-param">
...
<?php if(count($searches) > 0): ?><button class="btn submit-btn" url="?status=-1" target-form="ids" style="padding: 6px 16px;" onclick="toggle_search()">搜索</button><?php endif; ?>
            ...
            <div style="float: right;" >
                ...
                <form id="selectForm" method="get" action="<?php echo ((isset($selectPostUrl) && ($selectPostUrl !== ""))?($selectPostUrl):'/platform/index.php?s=/admin/senglin/index.html'); ?>" class="form-dont-clear-url-param">
    ...
    <div class="with-padding">
        <table class="table table-bordered table-striped table-hover">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$e): $mod = ($i % 2 );++$i;?><tr>
                    <td><input class="ids" type="checkbox" value="<?php echo ($e['orderid']); ?>" name="ids[]"></td>
    ...
    <!--script type="text/javascript" src="/platform/Public/static/thinkbox/jquery.thinkbox.js"></script-->
    <script type="text/javascript">
//        //搜索功能
