                ...
                <div class="col-xs-7">
                    ...
                    <div style="margin: 20px 0 20px 20px;">
                        <?php if(is_array($rankList)): $i = 0; $__LIST__ = $rankList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><div class="row"
                                ...
                                <div class="col-xs-2">
                                    <?php if(($tab) == "rankVerifyWait"): ?><a class="btn btn-primary" href="<?php echo U('Ucenter/Index/rankVerifyCancel',array('rank_id'=>$rank['rank_id']));?>">取消申请</a><?php endif; ?>
                                    <?php if(($tab) == "rankVerifyFailure"): ?><a class="btn btn-primary" href="<?php echo U('Ucenter/Index/rankVerify',array('rank_user_id'=>$rank['id']));?>">重新申请</a><?php endif; ?>
                                </div>
