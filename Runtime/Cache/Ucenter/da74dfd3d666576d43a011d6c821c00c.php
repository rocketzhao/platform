...
<div class="col-xs-6 lg_left">
    <div class="col-xs-12">
        <div class="col-xs-12  lg_lf_top">
            <h2>欢迎回到 <?php if(($login_type) == "login"): ?><a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/platform" title="进入首页"><?php echo modC('WEB_SITE_NAME','OpenSNS开源社交系统','Config');?></a><?php else: echo modC('WEB_SITE_NAME','OpenSNS开源社交系统','Config'); endif; ?> ！</h2>
        </div>
        <div class="clearfix"></div>
        <form action="/platform/index.php?s=/ucenter/member/login.html" method="post" class="lg_lf_form ">
            <div class="row">
