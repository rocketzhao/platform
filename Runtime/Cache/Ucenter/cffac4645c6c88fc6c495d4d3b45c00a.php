...
<div id="main-container" class="container">
    ...
    <link href="/platform/Application/Ucenter/Static/css/center.css" type="text/css" rel="stylesheet">
    <section>
        <div class="col-xs-12 col-sm-offset-1 register clearfix" style="margin-top: 50px;margin-bottom: 110px;background-color: white;padding: 10px;">
            ...
            <?php if($step == 'start'): ?><div class="col-xs-6">
                    <form class="" action="/platform/index.php?s=/ucenter/member/step/step/finish.html" method="post">
...
<script src="/platform/Public/js/ext/lazyload/lazyload.js"></script>
    ...
    <link href="/platform/Application/Core/Static/css/form_check.css" rel="stylesheet" type="text/css">
    <script src='/platform/Application/Core/Static/js/form_check.js'></script>
    <script>
        // 验证密码长度
        $(function(){
