...
<div id="main-container" class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <a href="javascript:" onclick="insertFace($(this))">
                        <img class="weibo_type_icon" src="/platform/Application/Core/Static/images/bq.png"/>
                    </a>
                    <?php if(modC('CAN_IMAGE',1)): ?><a href="javascript:" id="insert_image" onclick="insert_image.insertImage(this)">
                        <img class="weibo_type_icon" src="/platform/Application/Weibo/Static/images/image.png"/>
                    </a><?php endif; ?>
                    <?php if(modC('CAN_TOPIC',1)): ?><a href="javascript:" onclick="insert_topic.InsertTopic(this)">
                        <img class="weibo_type_icon" src="/platform/Application/Weibo/Static/images/topic.png"/>
                    </a><?php endif; ?>
    ...
    <link href="/platform/Public/js/ext/webuploader/css/webuploader.css" type="text/css" rel="stylesheet"><?php endif; ?>
                ...
                <div>
                    <div class="top_self">
                        <?php if($self['cover_id']): ?><img class="cover uc_top_img_bg_weibo" src="<?php echo ($self['cover_path']); ?>">
                            <?php else: ?>
                            <img class="cover uc_top_img_bg_weibo" src="/platform/Application/Core/Static/images/bg.jpg"><?php endif; ?>
                        <?php if(is_login() && $self['uid'] == is_login()): ?><div class="change_cover"><a data-type="ajax" data-url="<?php echo U('Ucenter/Public/changeCover');?>"
                                    ...
                                    class="img-responsive" src="/platform/Application/Core/Static/images/fractional.png" style="width: 25px;"></a>
                            </div><?php endif; ?>
                    </div>
                </div>
